...
> 💡 상세한 설정 가이드는 [프로젝트 설정 가이드](docs/프로젝트_설정_가이드.md)를 참고하세요.  
...
#### 8단계: 실시간 알림 시스템 (95% 완료)
- [x] WebSocket 설정 및 핸들러 구현 ✅
- [x] 알림 메시지 브로드캐스트 ✅
- [x] 프론트엔드 WebSocket 클라이언트 ✅
- [x] Notification 엔티티 및 서비스 ✅
- [x] 단위 테스트 작성 및 통과 ✅
- [ ] 실제 동작 테스트 (수동 검증 필요) ⚠️
...
- [API 문서](docs/API_문서.md) - REST API 참고 문서 (Swagger UI 보조 자료)
- [개발 가이드](docs/개발_가이드.md) - 코딩 컨벤션 및 아키텍처 가이드
