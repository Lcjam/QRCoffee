...
public class OrderController {
    ...
    public ResponseEntity<ApiResponse<OrderResponse>> getOrder(@PathVariable Long orderId) {
        ...
        return ResponseEntity.ok(ApiResponse.success("주문 정보를 조회했습니다.", orderResponse));
    }
    ...
    public ResponseEntity<ApiResponse<List<OrderResponse>>> getOrdersByStatus(
        ...
        try {
            ...
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error("유효하지 않은 주문 상태입니다."));
        }
    }
    ...
    public ResponseEntity<ApiResponse<Long>> getTodayOrderCount(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(ApiResponse.success("오늘 주문 통계를 조회했습니다.", count));
    }
    ...
    public ResponseEntity<ApiResponse<Long>> getPendingOrderCount(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(ApiResponse.success("대기 중인 주문 개수를 조회했습니다.", count));
    }
}
